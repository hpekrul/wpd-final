<?php
/**
 * My final wpd theme functions and definitions
 *
...
function wpd_final_setup() {
	/*
		...
		* If you're building a theme based on My final wpd theme, use a find and replace
...
function wpd_final_widgets_init() {
    ...
    register_sidebar(
        array(
            'name'          => esc_html__( 'Footer', 'wpd_homework' ),
            'id'            => 'footer-1',
            'description'   => esc_html__( 'Add widgets here.', 'wpd_homework' ),
            'before_widget' => '<section id="%1$s" class="widget %2$s">',
            'after_widget'  => '</section>',
            'before_title'  => '<h2 class="widget-title">',
            'after_title'   => '</h2>',
...
function wpd_final_scripts() {
    wp_enqueue_style( 'bootstrap-5', get_template_directory_uri() . '/css/bootstrap.min.css', array(), '5.3.1' );
    //fonts
    wp_enqueue_style( 'wpd_final_fonts', get_template_directory_uri() . '/fonts/Seuss-G4Ra.ttf', array(), '1' );
